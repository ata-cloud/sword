...
public class SqlDetailInterceptor implements Interceptor {

    /**
     * logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(SqlDetailInterceptor.class);
    ...
    private String formatSql(String sql, Object parameterObject, List<ParameterMapping> parameterMappingList) {
        ...
        try {
            ...
            LOGGER.warn("sql解析异常, sql:{}", sqlWithoutReplacePlaceholder, e);
     ...
     * 处理通用的场景
     */
    private String handleCommonParameter(String sql, List<ParameterMapping> parameterMappingList, Class<?> parameterObjectClass, Object parameterObject)
            throws Exception {
        for (ParameterMapping parameterMapping : parameterMappingList) {
            ...
            if (isPrimitiveOrPrimitiveWrapper(parameterObjectClass)) {
                ...
                if (parameterObject instanceof MapperMethod.ParamMap) {
                    propertyValue = String.valueOf(((MapperMethod.ParamMap) parameterObject).get(propertyName));
                } else {
